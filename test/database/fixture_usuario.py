...
def usuario_test():
     return UsuarioBD(
         id= None, #AutoAsignado en la base de datos como autoincremental
         nombre= "Jose",
         apellido= "Moyano",
...
def usuario_modificado_test():
     return UsuarioBD(
         id= None, #El id no se tiene en cuenta para la modificacion #TODO crear logica de reasignacion de id's (No recomendado)
